...
export default function Signup() {
  ...
  return (
    <div className="bg-slate-50 flex justify-center items-center h-screen">
      ...
      <div className="lg:px-20 lg:py-12 md:px-16 md:py-10 px-8 py-8 w-full lg:w-1/2 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          <h1 className="text-3xl font-light mb-6 text-slate-800">Sign Up</h1>
          ...
          <form onSubmit={handleSubmit}>
            {/* Username Input */}
            <div className="mb-3">
              <label htmlFor="username" className="block text-sm font-light text-slate-600 mb-2">Username</label>
              <input
                type="text"
                id="username"
                name="username"
                ...
                disabled={isLoading}
                className={`w-full bg-white border rounded-lg py-2.5 px-4 text-slate-900 font-light placeholder:text-slate-400 placeholder:font-light focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${errors.username && touched.username
            ...
            <div className="mb-6">
              <label htmlFor="confirmPassword" className="block text-sm font-light text-slate-600 mb-2">Confirm Password</label>
              <div className="relative">
                <input
                  ...
                  disabled={isLoading}
                  className={`w-full bg-white border rounded-lg py-2.5 px-4 pr-12 text-slate-900 font-light placeholder:text-slate-400 placeholder:font-light focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${errors.confirmPassword && touched.confirmPassword
                    ? 'border-red-500 focus:ring-red-500'
                    : 'border-slate-200 focus:ring-emerald-500 focus:border-transparent'
                    }`}
                  autoComplete="new-password"
          ...
          <div className="mt-6 text-center">
            <span className="text-sm font-light text-slate-600">Already have an account? </span>
            <Link href="/login" className="text-sm font-light text-emerald-600 hover:text-emerald-700 hover:underline transition-colors">Login</Link>
          </div>
        </div>
      </div>
    </div>
